...
// --- REQUIRED FIELDS ---
$requiredFields = ['brandname', 'email', 'password', 'location', 'call_number', 'whatsapp_number'];
...
// --- HANDLE LOGO UPLOAD (save in root) ---
$logoPath = null;
...
// --- INSERT SELLER ---
$stmt = $db->prepare("
    INSERT INTO sellers (brandname, email, password, call_number, whatsapp_number, address, verified)
    VALUES (?, ?, ?, ?, ?, ?, 0)
");
$stmt->execute([$brandname, $email, $passwordHash, $call_number, $whatsapp_number, $address]);
